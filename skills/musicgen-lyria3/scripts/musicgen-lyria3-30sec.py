...
def embed_metadata(
    ...
    album: str = "Lyria 3 Generated Singles",
    genre: str = "AI Music",
    ...
    try:
        ...
        if lyrics_text and lyrics_text.strip():
            ...
            tags.delall("COMM")
            comm_text = f"Generato con Google Lyria 3. Artista: {artist}\n\nLYRICS / TESTO:\n{clean_lyrics}"
            tags.add(COMM(encoding=3, lang="ita", desc="", text=comm_text))

        tags.delall("TXXX:AI_TOOL")
        tags.add(TXXX(encoding=3, desc="AI_TOOL", text="Google Lyria 3 (lyria-3-clip-preview)"))
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate 30-second Lyria 3 music clips with automatic ID3 tagging and lyrics.",
    ...
    parser.add_argument(
        "--album",
        type=str,
        default="Lyria 3 Generated Singles",
