...
version: 0.0.1
# Vibecoded while talking to Hussain Chinoy :)
---
...
# Specify custom bucket and region
python3 scripts/inject_settings.py --project <YOUR_PROJECT_ID> --bucket <YOUR_BUCKET_NAME> --region us-central1
```
